  ...
  return (
    ...
    >
      ...
      <Box sx={{ textAlign: "center", mt: { xs: -10, sm: -22 } }}>
        ...
        <Box
          ref={ref}
          sx={{ maxWidth: 800, m: "auto", mb: 2, mt: { xs: 5, sm: 10 } }}
        >
          <Slide direction="left" in={inView} timeout={500}>
            ...
            >
              Somos el{" "}
              <span style={{ color: "#E2b753", fontFamily: "Century Gothic" }}>
                Tío Barbershop
              </span>
              , el lugar donde la tradición se encuentra con la modernidad.
              Nuestro equipo de{" "}
              <span style={{ color: "#E2b753", fontFamily: "Century Gothic" }}>
                barberos expertos
              </span>{" "}
              está aquí para brindarte el{" "}
              <span style={{ color: "#E2b753", fontFamily: "Century Gothic" }}>
                mejor servicio{" "}
              </span>
              en:
          ...
          <Slide direction="left" in={inView} timeout={800}>
            ...
            >
              <strong style={{ fontFamily: "Century Gothic" }}>
                {" "}
                Corte de cabello y Estilizado de barba.
              </strong>
            </Typography>
          </Slide>
        </Box>
