...
const CardServicesMainSlider = ({ servicio, onSelect, dataCita, withButtons = true, windowWidth }) => {
	...
	return (
		...
		>
			<CardMedia component='img' alt='Servicios' height={windowWidth < 800 ? "200" : "300"} image={hovered ? servicio?.imagenes[imageIndex]?.url : servicio?.imagenes[0]?.url} />
			<CardContent>
