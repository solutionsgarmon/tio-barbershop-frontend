...
const CardServices = ({ servicio, onSelect, dataCita, withButtons = true }) => {
	...
	return (
		...
		>
			<CardMedia component='img' alt='Servicio' height='150' image={hovered ? servicio?.imagenes[imageIndex]?.url : servicio?.imagenes[0]?.url} />
			<CardContent>
				<Typography gutterBottom variant='h5' component='div'>
					{servicio?.nombre}
				</Typography>
				<Typography variant='body2' color='text.secondary' sx={{ height: 70, textAlign: "justify", fontSize: "1.1rem" }}>
