...
export default function MySwitch() {
  ...
  useEffect(() => {
    console.log("essionDataStorage?.descanso", sessionDataStorage?.descanso);
    if (sessionDataStorage?.descanso == "SI") {
      setChecked(true);
    } else {
      setChecked(false);
    }
  }, [sessionDataStorage.descanso]);
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (resp.data.success) {
        ...
        newSessionDataStorage.descanso =
          sessionDataStorage.descanso == "SI" ? "NO" : "SI";
  ...
  return (
    <FormGroup>
      ...
      <FormControlLabel
        ...
        label={checked ? "Descansando" : "Disponible"}
      />
    </FormGroup>
  );
}
