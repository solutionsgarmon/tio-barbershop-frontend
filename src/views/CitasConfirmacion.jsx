...
import { Card, CardContent, Typography, Button, IconButton, Stack, TextField, Grid } from "@mui/material";
...
const CitasConfirmacion = ({ setDataCita, dataCita, confirmacion, setConfirmacion }) => {
	...
	const handleSubmit = () => {
		...
		const values = {
			...
			fecha_asignada_fin: dataCita.fecha,
			estatus: "PENDIENTE",
	...
	return (
		...
		>
			<CardContent>
				<img src={dataCita?.imagen_barbero} alt='Imagen del barbero' style={{ maxWidth: "100%", borderRadius: "50%", marginBottom: 5 }} />
				<Typography variant='text.secondary' sx={{ textAlign: "center", fontFamily: "Century Gothic" }}>
					Barbero
				</Typography>
				<Typography variant='h5' sx={{ textAlign: "center", fontFamily: "Century Gothic" }}>
					{dataCita.barbero}
				</Typography>
				<br /> <br />
				<Stack direction='row'>
					<BusinessIcon />
					<Typography variant='subtitle1' gutterBottom sx={{ ml: 1, fontFamily: "Century Gothic" }}>
						{dataCita.barberia}
					</Typography>
				</Stack>
				<Stack direction='row'>
				...
				<Stack direction='row'>
					<AccessTimeIcon />
					<Typography variant='subtitle1' gutterBottom sx={{ ml: 1, fontFamily: "Century Gothic" }}>
						{sumarMinutosAHora(dataCita.hora, dataCita.duracion)} - Salida Aprox.
					</Typography>
				</Stack>
				<br /> <br />
				{/* FORMULARIO */}
					...
					<Grid container spacing={2} direction='column'>
						...
						<Grid item xs={12}>
							<TextField
								...
								error={errorTelefono}
								helperText={errorTelefono && errorTelefono.length != 10 && "Ingresa 10 dígitos"}
							/>
						</Grid>
						<Grid item xs={12}>
							<TextField
						...
						<Grid item xs={12}>
							<TextField id='outlined-multiline-static' label='Agrega una nota...' multiline rows={4} value={nota} onChange={(event) => setNota(event.target.value)} variant='outlined' fullWidth />
						</Grid>
					</Grid>
				</form>
			</CardContent>
